    ...
    >
      <div className="bg-black/30 w-full h-full flex items-center">
        <div className="max-w-5xl mx-auto px-6 w-full relative">
          ...
          {/* Headline - Updated styling with gradient and different emphasis */}
          ...
          {/* Quick Stats */}
          <div className="mt-10 md:mt-12 flex flex-wrap gap-6 md:gap-10 text-white animate-fadeIn">
            <div className="flex flex-col">
              <span className="text-3xl md:text-4xl font-black text-primary">50+</span>
              <span className="text-sm md:text-base font-medium opacity-90">Verified Nurseries</span>
            </div>
            <div className="flex flex-col">
              <span className="text-3xl md:text-4xl font-black text-primary">1000+</span>
              <span className="text-sm md:text-base font-medium opacity-90">Plant Varieties</span>
            </div>
            <div className="flex flex-col">
              <span className="text-3xl md:text-4xl font-black text-primary">24/7</span>
              <span className="text-sm md:text-base font-medium opacity-90">Online Booking</span>
            </div>
          </div>
